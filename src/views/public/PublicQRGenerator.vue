...
import { generatePublicQRCode, checkUrlValidity } from '../../api/qrcode'
import {
  Link,
  Document,
  Picture,
...
const submit = async () => {
  ...
  try {
    ...
    const res = await generatePublicQRCode(formData)
...
@media (max-width: 768px) {
  ...
  .settings-row :deep(.el-form-item) {
    width: 100%;
  }
